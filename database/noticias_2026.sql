...
DELETE FROM news WHERE slug IN (
  ...
  'nova-ciclovia-centro-parque',
  'vitoria-sc-reforcos-2024',
  'camara-orcamento-2024',
  'mercado-guimaraes-renovacao',
  'escola-musica-inscricoes',
  'bombeiros-nova-viatura',
  'festival-gastronomico-sabores',
  'biblioteca-horario-ampliado',
  'parque-equipamento-desportivo',
  'guimaraes-mobilidade-sustentavel',
  'nova-ciclovia-centro-parque',
  'vitoria-sc-reforcos-2024',
  'vimaranes-hub-coworking',
  'festival-gastronomia-sabores-berco',
  'guimaraes-empreendedor-startups',
  'castelo-guimaraes-restauracao'
);

-- Inserir notícias de 2026

-- Notícia 1: Mobilidade Sustentável
INSERT INTO news (title, excerpt, content, image, category_id, author_id, slug, featured, published, published_at) VALUES
(
  'Guimarães Completa Rede de Ciclovias e Autocarros Elétricos Reduzem Emissões em 35%',
  'A Câmara Municipal de Guimarães celebra o sucesso do plano de mobilidade sustentável com resultados que superaram as expectativas.',
...
<p><em>Fontes: Câmara Municipal de Guimarães, Relatório de Mobilidade Sustentável 2026, Comissão Europeia</em></p>',
  ...
  1, 2, 'guimaraes-mobilidade-sustentavel-2026', true, true, '2026-04-20'
);

-- Notícia 2: Vitória SC
INSERT INTO news (title, excerpt, content, image, category_id, author_id, slug, featured, published, published_at) VALUES
(
  'Vitória SC Conquista Taça de Portugal e Garante Participação na Liga dos Campeões',
  'O clube vimaranense celebra uma época histórica com a conquista da Taça de Portugal e qualificação para a Liga dos Campeões 2026/2027.',
...
<p><em>Fontes: Vitória Sport Clube, Federação Portuguesa de Futebol</em></p>',
  ...
  3, 4, 'vitoria-sc-taca-portugal-2026', true, true, '2026-04-18'
);

-- Notícia 3: Coworking
INSERT INTO news (title, excerpt, content, image, category_id, author_id, slug, featured, published, published_at) VALUES
(
  'Vimaranes Hub Completa Dois Anos com 150 Empresas Instaladas e 500 Postos de Trabalho',
  'O espaço de coworking consolidou-se como um motor de inovação e empreendedorismo em Guimarães.',
...
<p><em>Fontes: Vimaranes Hub, Câmara Municipal de Guimarães</em></p>',
  ...
  5, 2, 'vimaranes-hub-dois-anos-2026', false, true, '2026-04-15'
);

-- Notícia 4: Festival de Gastronomia
INSERT INTO news (title, excerpt, content, image, category_id, author_id, slug, featured, published, published_at) VALUES
(
  'Festival de Gastronomia Tradicional Regressa em Maio com Recordes de Visitantes',
  'O "Sabores do Berço" atrai 15.000 visitantes e gera €500 mil em receita para restaurantes locais.',
...
<p><em>Fontes: Associação de Restaurantes de Guimarães, Câmara Municipal</em></p>',
  ...
  2, 5, 'festival-gastronomia-2026', false, true, '2026-04-12'
);

-- Notícia 5: Programa de Startups
INSERT INTO news (title, excerpt, content, image, category_id, author_id, slug, featured, published, published_at) VALUES
(
  'Programa Guimarães Empreendedor Completa Primeira Edição com 25 Startups Apoiadas',
  'O programa de apoio a startups superou expectativas com 25 empresas financiadas e 200 postos de trabalho criados.',
...
<p><em>Fontes: Câmara Municipal de Guimarães, Programa Guimarães Empreendedor</em></p>',
  'https://images.unsplash.com/photo-1552664730-d307ca884978?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80',
  5, 2, 'guimaraes-empreendedor-primeira-edicao', false, true, '2026-04-10'
);

-- Notícia 6: Restauração do Castelo
INSERT INTO news (title, excerpt, content, image, category_id, author_id, slug, featured, published, published_at) VALUES
(
  'Castelo de Guimarães Reabre Após Restauração com Novos Espaços de Interpretação',
  'O projeto de restauração de €2 milhões foi concluído com sucesso, reforçando as estruturas medievais e melhorando a experiência dos visitantes.',
...
<p><em>Fontes: Câmara Municipal de Guimarães, UNESCO, Instituto da Conservação e Restauro</em></p>',
  ...
  2, 1, 'castelo-guimaraes-restauracao-2026', false, true, '2026-04-08'
);
